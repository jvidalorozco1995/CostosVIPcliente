<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebLineasRetiradasLineaBase.aspx.cs" Inherits="WebCostos.WebLineasRetiradasLineaBase" %>
...
<body>
  ...
  OnClientClick  ="JavaScript: window.history.back(1); return false;"></asp:LinkButton>
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Font-Names="Calibri" Font-Size="12pt" EmptyDataText="No hay Lineas Retiradas de estas fechas">
            <Columns>
...
where   IdFecha=@IdFecha2  and not exists

(
SELECT        1
FROM            dbo.CostosPptoProg  as t2
WHERE        (t2.referencia1 = t1.referencia1) and IdFecha=@IdFecha1)">
            <SelectParameters>
               <asp:SessionParameter Name="IdFecha1" SessionField="FechaActual" Type="String"  />
                <asp:SessionParameter Name="IdFecha2" SessionField="FechaLineaBase" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </form>
</body>
