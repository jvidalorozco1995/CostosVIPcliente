...
namespace WebCostos
{
    public partial class WebComparacionesLineaBase : System.Web.UI.Page
    {
        ...
        {
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "", "open('WebLineasAgregadasLineaBase.aspx','NewWindow','top=0,left=0,width=800,height=600,status=yes,resizable=yes,scrollbars=yes');", true);
        }

        protected void BtnRetiradas_Click1(object sender, EventArgs e)
        {
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "", "open('WebLineasRetiradasLineaBase.aspx','NewWindow','top=0,left=0,width=800,height=600,status=yes,resizable=yes,scrollbars=yes');", true);
