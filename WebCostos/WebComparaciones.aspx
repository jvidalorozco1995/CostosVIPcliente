<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebComparaciones.aspx.cs" Inherits="WebCostos.WebComparaciones" %>
...
<body>
    ...
    <div style="margin-left: auto; margin-right: auto; text-align: center;">
        <asp:Label ID="Label1" runat="server" Font-Size="X-Large" Text="Comparaciones Semana Actual VS Semana Pasada"  ForeColor="#B70000" Font-Names="Calibri" style="text-align: center; align-content:center;"></asp:Label>
      </div> 
    ...
    <asp:SqlDataSource ID="CargarGrilla" runat="server" ConnectionString="<%$ ConnectionStrings:COSTOSVIPConnectionString %>" SelectCommand="ComparacionesModificaciones" SelectCommandType="StoredProcedure" OnSelecting="CargarGrilla_Selecting">
            <SelectParameters>
                ...
                <asp:SessionParameter Name="Fecha2" SessionField="FechaPasada" Type="String" />
