<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Informe.aspx.cs" Inherits="WebCostos.Informe" %>
        ...
        <table class="table table-striped table-bordered table-hover" style="width:27%">
            ...
            <tbody>
                <tr ng-repeat="i in ConCostosDirectosSemanaActual">
                    ...
                    <td class="col-md-1" style="text-align:right;">{{i.Vlrproy | euro }}</td>
                    <td ng-repeat="i in ConCostosDirectosSemanaPasada" class="col-md-1" style="text-align:right;">{{i.Vlrproy | euro }}</td>
                    <td ng-repeat="i in ConCostosDirectosSemanaLineaBase" class="col-md-1" style="text-align:right;">{{i.Vlrproy | euro }}</td>

                <tr ng-repeat="i in ConCostosDirectosSemanaActual">
                    <th class="success"> Vlr mt2 vivienda</th>
                    <td class="col-md-1" style="text-align:right;">{{i.Vlrmt2vivienda | euro }}</td>
                    <td ng-repeat="i in ConCostosDirectosSemanaPasada" class="col-md-1" style="text-align:right;">{{i.Vlrmt2vivienda | euro }}</td>
                    <td ng-repeat="i in ConCostosDirectosSemanaLineaBase" class="col-md-1" style="text-align:right;">{{i.Vlrmt2vivienda | euro }}</td>

                <tr ng-repeat="i in ConCostosDirectosSemanaActual">
                    <th class="success"> Vlr x vivienda</th>
                    <td class="col-md-1" style="text-align:right;">{{i.Vlrxvivienda | euro }}</td>
                    <td ng-repeat="i in ConCostosDirectosSemanaPasada" class="col-md-1" style="text-align:right;">{{i.Vlrxvivienda | euro }}</td>
                    <td ng-repeat="i in ConCostosDirectosSemanaLineaBase" class="col-md-1" style="text-align:right;">{{i.Vlrxvivienda | euro }}</td>
                </tr>
        ...
        <table class="table table-striped table-bordered table-hover" style="width:27%">
            ...
            <tbody>
                <tr ng-repeat="i in ConCostosIndirectosSemanaActual">
                    <th class="success"> Vlr Proy</th>
                    <td class="col-md-1" style="text-align:right;">{{i.Vlrproy | euro }}</td>
                    <td ng-repeat="i in ConCostosIndirectosSemanaPasada" class="col-md-1" style="text-align:right;">{{i.Vlrproy | euro }}</td>
                    <td ng-repeat="i in ConCostosIndirectosSemanaLineaBase" class="col-md-1" style="text-align:right;">{{i.Vlrproy | euro }}</td>


                <tr ng-repeat="i in ConCostosIndirectosSemanaActual">
                    <th class="success"> Vlr mt2 vivienda</th>
                    <td class="col-md-1" style="text-align:right;">{{i.Vlrmt2vivienda | euro }}</td>
                    <td ng-repeat="i in ConCostosIndirectosSemanaPasada" class="col-md-1" style="text-align:right;">{{i.Vlrmt2vivienda | euro }}</td>
                    <td ng-repeat="i in ConCostosIndirectosSemanaLineaBase" class="col-md-1" style="text-align:right;">{{i.Vlrmt2vivienda | euro }}</td>


                <tr ng-repeat="i in ConCostosIndirectosSemanaActual">
                    <th class="success"> Vlr x vivienda</th>
                    <td class="col-md-1" style="text-align:right;">{{i.Vlrxvivienda | euro }}</td>
                    <td ng-repeat="i in ConCostosIndirectosSemanaPasada" class="col-md-1" style="text-align:right;">{{i.Vlrxvivienda | euro }}</td>
                    <td ng-repeat="i in ConCostosIndirectosSemanaLineaBase" class="col-md-1" style="text-align:right;">{{i.Vlrxvivienda | euro }}</td>
